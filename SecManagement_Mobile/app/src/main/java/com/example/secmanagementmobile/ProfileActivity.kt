...
import com.example.secmanagementmobile.models.FormadorProfileDto
import com.example.secmanagementmobile.models.FormandoProfileDto
...
import com.example.secmanagementmobile.utils.FileOpenUtils
import kotlinx.coroutines.*
import androidx.recyclerview.widget.LinearLayoutManager
import androidx.recyclerview.widget.RecyclerView
import com.example.secmanagementmobile.models.UserFicheiroDto
import com.example.secmanagementmobile.ui.FicheirosAdapter
...
class ProfileActivity : AppCompatActivity() {
    ...
    private fun showFicheiros(list: List<UserFicheiroDto>?) {
        ...
        if (safe.isEmpty()) {
            txtFicheirosEmpty.visibility = android.view.View.VISIBLE
            rvFicheiros.visibility = android.view.View.GONE
        } else {
            txtFicheirosEmpty.visibility = android.view.View.GONE
            rvFicheiros.visibility = android.view.View.VISIBLE
